...
/* end template head */ ob_start(); /* template body */ ?><div class="panel panel-default">
    ...
    <ul class="list-group">
        <?php 
$_fh6_data = (is_string($tmp=(isset($this->scope["sbdata"]["users"]) ? $this->scope["sbdata"]["users"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);
if ($this->isTraversable($_fh6_data) == true)
{
	foreach ($_fh6_data as $this->scope['user'])
	{
